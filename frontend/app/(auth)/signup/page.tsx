    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background">
      ...
      <div className="fixed inset-0 -z-10">
        <EtheralShadow
          ...
          sizing="fill"
        />
        <div className="absolute top-0 right-1/4 w-96 h-96 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-full blur-[128px]" />
        <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-gradient-to-br from-emerald-500/20 to-blue-500/20 rounded-full blur-[128px]" />
      </div>
      ...
      >
        <div className="rounded-2xl border border-border/50 bg-card/60 backdrop-blur-xl p-8 shadow-2xl">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-muted-foreground mt-2">Get started with serverless data processing</p>
          </div>
          ...
          <div className="mt-8 text-center text-sm text-muted-foreground">
            ...
            <Link href="/signin" className="font-semibold text-blue-500 hover:text-blue-400 transition-colors">
              Sign in
            </Link>
          </div>
        </div>
